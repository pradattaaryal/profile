      ...
      <div className='max-w-[1140px] h-screen m-auto'>
        ...
        <div className='  grid col-span-3 w-full md:max-w-[1140px]   min-h-[70vh] md:p-6'>
          ...
          <div className='w-full h-full  gap-2  grid md:grid-cols-3  grid-cols-2  p-4'>
            {data.map((item, index) => (
              <div className='max-h-[200px] p-2 h-[200px] max-w-[200px] border-2 border-solid border-black hover:shadow-2xl hover:scale-105 hover:shadow-slate-950  mb-6 transition duration-600 shadow-lg rounded-md' key={index}>
