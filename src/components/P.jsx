...
export default function P() {
  return (
    <section className="w-full h-screen py-12 md:py-24 lg:py-32 flex justify-center bg-white ">
<div className="max-w-[1140px] w-full h-full  border-2 border-black shadow-2xl rounded-2xl p-10">  
