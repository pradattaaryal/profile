...
const About = () => {
  return (
     ...
     <div  className='h-screen max-w-[1140px]  m-auto  '>
      ...
      <div className='  w-[50%] flex items-center  justify-center mb-5 '><img className="rounded-3xl border-3 border-black shadow-2xl h-[180px] w-[160px]  sm:h-[280px] sm:w-[250px] md:h-[400px] md:w-[350px] " src={y} alt=""  /></div>
